...
class ClassesController extends Controller
{
     ...
     */
    public function actionView($class_name)
    {
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($class_name)
    {
        $model = $this->findModel($class_name);
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($class_name)
    {
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($class_name)
    {
